...
'home.about.title_post' => [
    'it' => ', il vostro autonoleggio a Sharm.',
    'en' => ', your car rental in Sharm.',
    'ru' => ', ваш прокат авто в Шарме.',
    'es' => ', vuestro alquiler de coches en Sharm.',
    'de' => ', deine Autovermietung in Sharm.',
],
'home.about.p1' => [
    'it' => 'Da oltre <strong>quindici anni</strong> mi occupo di <strong>noleggio auto</strong> a Sharm El Sheikh. Tour operator, italiani in vacanza, dipendenti d\'hotel, gente del posto: a Sharm sanno tutti che per un\'auto si chiama <strong>Alex</strong>. Ho iniziato con una sola Toyota e oggi gestisco una flotta di <strong>auto controllate una per una</strong>, pulite, in ordine, sempre pronte alla consegna. Niente sorprese, niente brutte figure davanti all\'hotel.',
    'en' => 'I\'ve been running a <strong>car rental business</strong> in Sharm El Sheikh for over <strong>fifteen years</strong>. Tour operators, returning tourists, hotel staff, locals: in Sharm everyone knows that for a car you call <strong>Alex</strong>. I started with a single Toyota and today I run a fleet of <strong>cars I personally inspect</strong> — clean, in order, always ready for handover. No surprises, no awkward moments at the hotel.',
    'ru' => 'Уже более <strong>пятнадцати лет</strong> я занимаюсь <strong>прокатом автомобилей</strong> в Шарм-эль-Шейхе. Туроператоры, постоянные туристы, сотрудники отелей, местные — в Шарме все знают, что за машиной звонят <strong>Алексу</strong>. Начал с одной Toyota, сегодня — целый парк <strong>лично проверенных авто</strong>: чистых, ухоженных, всегда готовых к выдаче. Никаких сюрпризов и неловких ситуаций у отеля.',
    'es' => 'Desde hace más de <strong>quince años</strong> me dedico al <strong>alquiler de coches</strong> en Sharm El Sheikh. Tour operadores, turistas habituales, personal de hotel, gente del lugar: en Sharm todos saben que para un coche se llama a <strong>Alex</strong>. Empecé con un solo Toyota y hoy gestiono una flota de <strong>coches revisados uno a uno</strong>, limpios, en orden, siempre listos para la entrega. Sin sorpresas, sin pasar vergüenza delante del hotel.',
    'de' => 'Seit über <strong>fünfzehn Jahren</strong> betreibe ich eine <strong>Autovermietung</strong> in Sharm El Sheikh. Reiseveranstalter, Stammgäste, Hotelpersonal, Einheimische — in Sharm weiß jeder: wer ein Auto braucht, ruft <strong>Alex</strong> an. Begonnen mit einem einzigen Toyota, heute eine ganze Flotte <strong>persönlich geprüfter Autos</strong> — sauber, gepflegt, immer übergabebereit. Keine Überraschungen, keine peinlichen Momente vor dem Hotel.',
],
'home.about.p2' => [
    'it' => '<strong>Consegno l\'auto direttamente in hotel o in aeroporto</strong>, ti spiego le strade, i parcheggi, i posti dove mangiare bene. Se ti serve un cambio veicolo, un transfer last-minute o un consiglio sul momento: rispondo <strong>io stesso su WhatsApp, in italiano, a qualunque ora</strong>. Niente call center, niente intermediari, nessuna sorpresa al ritiro. A Sharm la differenza la fa la <strong>persona di fiducia</strong>.',
    'en' => 'I <strong>deliver the car straight to your hotel or to the airport</strong>, walk you through the roads, parking, the right places to eat. If you need to swap vehicles, arrange a last-minute transfer or just want a local tip: I <strong>answer myself on WhatsApp, anytime</strong>. No call centres, no middlemen, no surprises at pick-up. In Sharm the difference is the <strong>person you can trust</strong>.',
    'ru' => '<strong>Привожу авто прямо в отель или аэропорт</strong>, объясню дороги, парковки, лучшие места для ужина. Нужно поменять машину, срочный трансфер или местный совет — отвечу <strong>сам в WhatsApp, в любое время</strong>. Никаких колл-центров и посредников, никаких сюрпризов при выдаче. В Шарме разницу делает <strong>человек, которому доверяешь</strong>.',
    'es' => '<strong>Te entrego el coche directamente en el hotel o en el aeropuerto</strong>, te explico las carreteras, los aparcamientos y los buenos restaurantes. Si necesitas cambiar de coche, un traslado de última hora o un consejo sobre la marcha: respondo <strong>yo mismo en WhatsApp, a cualquier hora</strong>. Sin call centers, sin intermediarios, sin sorpresas en la entrega. En Sharm la diferencia la marca la <strong>persona de confianza</strong>.',
    'de' => 'Ich <strong>liefere das Auto direkt ins Hotel oder zum Flughafen</strong>, erkläre dir die Strecken, die Parkplätze, die guten Restaurants. Brauchst du einen Fahrzeugwechsel, einen Last-minute-Transfer oder einen Tipp vor Ort: <strong>Ich antworte selbst auf WhatsApp, rund um die Uhr</strong>. Keine Callcenter, keine Vermittler, keine Überraschungen bei der Übergabe. In Sharm zählt der <strong>Mensch, dem du vertraust</strong>.',
],
